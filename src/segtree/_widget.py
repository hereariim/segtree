...
from segtree.utils import diamant_star, curr_sum_one, get_base_dir, pipe_f, frontground_part, keep_largest_object, centroid_msk, reattribute_data, area_pts, angle_assessment


def trunk_segmentation(bgr_data): 
    pth_trunk = os.path.join(
        get_base_dir(), "segtree", "best (1).pt"
